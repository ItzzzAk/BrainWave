...
export default {
  ...
  theme: {
    extend: {
      ...
      // Set default transition timing function
  ...
  plugins: [
    plugin(function ({ addBase, addComponents, addUtilities }) {
      // Add base styles (currently empty)
      addBase({});
